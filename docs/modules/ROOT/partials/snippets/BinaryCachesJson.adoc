...
// TODO: xref:reference:binary-cache-json.adoc[TODO]
NOTE: For more detail, see https://docs.hercules-ci.com/hercules-ci/reference/binary-caches-json/ in the Reference.
